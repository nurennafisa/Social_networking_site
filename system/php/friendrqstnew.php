...
WHERE user_two_id='$_SESSION[user_id]' AND status=0");
...
{ 
$_SESSION['profile']=$row1['user_id'];


$result2 = mysql_query("SELECT * FROM sign_up
 WHERE user_id= $_SESSION[profile] ");
...
$result3 = mysql_query("SELECT * FROM user_profile
WHERE user_id= $_SESSION[profile]");
